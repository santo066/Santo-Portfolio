...
export default function Skill() {
    return (
        <div className="md:pb-[100px] pb-11  md:px-0 px-[20px]" id="my_skill_section">
            <div className="container-sm">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 items-center justify-items-center mt-10 gap-x-[20px] gap-y-[50px]">
